...
const ElementProvider = props => {
	...
	const [selectedTarget, setSelectedTarget] = useState("hello");
	return (
		<ElementContext.Provider value={[selectedElement, setSelectedElement]}>
			<ElementContext2.Provider value={[selectedTarget, setSelectedTarget]}>{props.children}</ElementContext2.Provider>
