...
function TextShadow() {
  ...
  const handleInput = (e) => {
    ...
    switch (e.target.name) {
      case "BXposition":
        temp.boxShadow = `${value ? value : "0"}px ${
          BYposition ? BYposition : "0"
        }px ${BBlur ? BBlur : "0"}px ${BSpread ? BSpread : "0"}px ${
          color ? color : ""
        } ${Type ? Type : ""}`;
        break;
      case "BYposition":
        temp.boxShadow = `${BXposition ? BXposition : "0"}px ${
          value ? value : "0"
        }px ${BBlur ? BBlur : "0"}px ${BSpread ? BSpread : "0"}px ${
          color ? color : ""
        } ${Type ? Type : ""}`;
      ...
      case "BBlur":
        temp.boxShadow = `${BXposition ? BXposition : "0"}px ${
          BYposition ? BYposition : "0"
        }px ${value ? value : "0"}px ${BSpread ? BSpread : "0"}px ${
          color ? color : ""
        } ${Type ? Type : ""}`;
        break;
      case "BSpread":
        temp.boxShadow = `${BXposition ? BXposition : "0"}px ${
          BYposition ? BYposition : "0"
        }px  ${BBlur ? BBlur : "0"}px ${value ? value : "0"}px ${
          color ? color : ""
        } ${Type ? Type : ""}`;
        break;
      case "color":
