    ...
    <div className="expand-grid style-group">
      ...
      <div>
        ...
        <div className="shadow">
          <select
            ...
            value={backgroundRepeat ? backgroundRepeat : "repeat"}
      ...
      <div>
        ...
        <div className="shadow">
          <select
            ...
            value={backgroundPosition ? backgroundPosition : "left top"}
            onChange={handleSelect}
          >
      ...
      <div>
        ...
        <div className="shadow">
          <select
            ...
            value={backgroundAttachment ? backgroundAttachment : "scroll"}
            onChange={handleSelect}
          >
      ...
      <div>
        ...
        <div className="shadow">
          <select
            name="backgroundSize"
            value={backgroundSize ? backgroundSize : "auto"}
            onChange={handleSelect}
          >
