	...
	return (
		<div style={{ display: "none" }} className="style-group">
			<div>
				...
				<div>
					<select className="shadow" name="fontFamily" value={fontFamily ? fontFamily : ""} onChange={handleSelect}>
						<option value=""></option>
			...
			<div>
				...
				<div>
					...
					<input className="shadow" name="color" type="text" value={color ? color : ""} onChange={handleSelect} onKeyPress={checkInput}></input>
				</div>
			</div>
