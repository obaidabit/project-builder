			...
			<div>
				...
				<div className="flex-row shadow">
					...
					<div className="white">
						...
						<label className="icon-label" htmlFor="+width">
							<TiArrowSortedUp />
						</label>
			...
			<div>
				...
				<div className="flex-row shadow">
					...
					<div className="white">
						...
						<label className="icon-label" htmlFor="+height">
							<TiArrowSortedUp />
						</label>
			...
			<div>
				...
				<div className="flex-row shadow">
					...
					<div className="white">
						...
						<label className="icon-label" htmlFor="+max">
							<TiArrowSortedUp />
						</label>
			...
			<div>
				...
				<div className="flex-row shadow">
					...
					<div className="white">
						...
						<label className="icon-label" htmlFor="+min">
							<TiArrowSortedUp />
						</label>
