...
function Transition() {
  ...
  return (
    <div className="expand-grid m-t-2">
      <div>
        <span className="sub-head">Transition</span>
      </div>
        ...
        <div>
          ...
          <div>
            <select
              ...
              value={transitionProperty ? transitionProperty : ""}
        ...
        <div>
          ...
          <div className="shadow">
            <select
              ...
              value={transitionTimingFunction ? transitionTimingFunction : ""}
              onChange={handleInput}
            >
              <option value=""></option>
          ...
          <div>
            <div className="flex-row shadow">
              <input
                ...
                type="text"
                value={transitionDelay ? transitionDelay : ""}
                onChange={handleInput}
                onKeyPress={checkInput}
              ></input>
